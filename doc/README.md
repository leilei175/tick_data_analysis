...
> 本目录用于管理项目说明、下载/更新指南、转换流程和分析报告。

## 总览与快速开始

- [项目完整使用手册](./PROJECT_USAGE_GUIDE.md)
- [本地数据读取指南](./data_reading_guide.md)
- [数据更新指南](./data_update_guide.md)

## 数据下载

- [日线/基本面下载指南](./download_guide.md)
- [财务报表下载指南](./financial_downloader_guide.md)

## 数据转换

- [财务季度转每日指南](./financial_daily_converter_guide.md)
- [现金流季度转每日指南](./cashflow_converter_guide.md)
